...
// التحقق من وجود جدول exchanges وإنشاؤه إذا لم يكن موجوداً
$tableCheck = $db->queryOne("SHOW TABLES LIKE 'exchanges'");
if (empty($tableCheck)) {
    try {
        // إنشاء جدول exchanges
        $db->execute("
        ...
        // التحقق من وجود جدول exchange_return_items وإنشاؤه إذا لم يكن موجوداً
        ...
        // التحقق من وجود جدول exchange_new_items وإنشاؤه إذا لم يكن موجوداً
